...
As a result, the latest webdriver_manager (4.0.1) will not work in the examples' code. Search for a solution here: https://github.com/SergeyPirogov/webdriver_manager
