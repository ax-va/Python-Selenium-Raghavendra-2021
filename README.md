...
As a result, the latest webdriver-manager package (now 4.0.1) will not work in the examples' code. Search for a solution here: https://github.com/SergeyPirogov/webdriver_manager
