...
highlighter.highlight_element_and_wait(input_fname)

input_email = driver.find_element(By.NAME, "email")
highlighter.highlight_element_and_wait(input_email)
...
highlighter.highlight_element_and_wait(input_next)

input_location = driver.find_element(By.XPATH, "/html/body/form/input[5]")
highlighter.highlight_element_and_wait(input_location)

input_lname = driver.find_element(By.XPATH, "//form//input[2]")
highlighter.highlight_element_and_wait(input_lname)
...
highlighter.highlight_element_and_wait(input_password_list[0])
