...
# Click on element (without releasing) and hold
actions.click_and_hold(main_branch).pause(5).perform()
# Double-click
actions.double_click(on_element=main_branch).pause(5).perform()
